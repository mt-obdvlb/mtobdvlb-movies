        ...
        <div
          ...
          transform hover:translate-x-2'>
            <AiOutlineHome className='mr-2 mt-[3rem]'
                           size={26}/>
            <span
              className='hidden nav-item-name mt-[3rem]'>主页</span>
          </Link>
          <Link to='/movies'
                className='flex items-center transition-transform transform hover:translate-x-2 ml-[1rem]'>
            <MdOutlineLocalMovies className='mr-2 mt-[3rem]'
                                  size={26}/>
            <span
        ...
        <div className='relative'>
          <button onClick={toggleDropdown}
                  className='cursor-pointer text-gray-800 focus:outline-none'>
            {
              userInfo ? (
                <span
                  className='text-white'>{userInfo.username}</span>
              ) : (
                <></>
              )
            }
            ...
            {userInfo && (
              <svg
                ...
                className={`h-4 w-4 ml-1 transform transition-all duration-300 ${
                  dropdownOpen ? ' rotate-0' : ''
                }`}
                fill='none'
                viewBox='0 0 24 24'
                stroke='white'
              ...
              <li>
                <button onClick={logoutHandler}
                        className={'block w-full' +
                          ' px-4 py-2 text-left hover:bg-gray-100 cursor-pointer'}>
                  注销
                </button>
              </li>
            </ul>
          ...
          {!userInfo && (
            <ul className={'flex'}>
              <li>
                ...
                >
                  <AiOutlineLogin className='mr-2 mt-[4px]'
                                  size={26}/>
                  <span
              ...
              <li>
                ...
                >
                  ...
                  <span
                    className='hidden nav-item-name'>注册</span>
                </Link>
              </li>
            </ul>
          )}
